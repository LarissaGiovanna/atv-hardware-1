...
module tb_modulo_hex;
    ...
    initial begin
        ...
        esperado[10] = {7'b1110111, 1'b0}; 
        esperado[11] = {7'b0011111, 1'b0}; 
        esperado[12] = {7'b1001110, 1'b0}; 
        esperado[13] = {7'b0111101, 1'b0}; 
        esperado[14] = {7'b1001111, 1'b0}; 
        esperado[15] = {7'b1000111, 1'b0}; 
    end

    initial begin
        $dumpfile("onda_hex.vcd");
        $dumpvars(0, tb_modulo_hex);
    end

    initial begin
        erros = 0;
        $display("=== INICIO DOS TESTES: Desafio Hex (0-F) ===");
        $display(" d  | seg[6:0] | E | esperado seg | esperado E | resultado");
        $display("----+----------+---+--------------+------------+----------");
